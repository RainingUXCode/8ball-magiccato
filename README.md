...
- 🐱 Interactive design with a cat-themed 8-ball.
- 🎲 Randomized responses every time you click the button.
...
1. Open the project in your browser (just double-click `index.html` or host it locally).
2. Think of a question you’d like to ask.
3. Click the button under the cat.
4. The cat will “reveal” a random answer! 🪄
...
- **JavaScript (ES6)** – random response logic

---

## 💡 Inspiration

This project was inspired by the **JavaScript Magic 8-Ball exercise** from [Codédex](https://www.codedex.io/).  
